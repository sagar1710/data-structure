...
my_list = LinkedList()
my_list.add_head(l1)
my_list.add_tail('Element2')
my_list.add_tail('Element3')
my_list.add_tail('Element4')
...
my_list2.add_tail('Element6')
my_list2.add_tail('Element7')
my_list2.add_tail('Element8')
my_list.merge(my_list2)
my_list.get_previous_node_at(3).element
my_list.reverse_display()
my_list.search('Element6')
